    ...
    <>
      <div className="flex flex-col lg:hidden">
        <div className="!h-[700px] !w-full md:!h-[300px]">
          <img src={mobileabout} className="w-full" alt="spectrum about" />
        </div>
        <div
          className="relative mx-[16px] bottom-[100px] md:bottom-[-1000px] left-0 right-0
      md:mx-[45px] py-[24px] px-[16px] rounded-[20px] border-2 border-[#EDEDF2] bg-white shadow-spec"
        >
          <h1 className="text-[#5F5F8C] font-graphik font-semibold text-[16px] text-center leading-[24px]">
            Our journey began with a simple idea: to redefine what's possible.
            Today, that idea has blossomed into a thriving hub of creativity,
            collaboration, and ingenuity. We take pride in our commitment to
            delivering outstanding products/services that not only meet but
          ...
          <h1 className="pt-[16px] text-[#5F5F8C] font-graphik font-semibold text-[16px] text-center leading-[24px]">
            Rooted in a foundation of expertise and driven by a forward-thinking
            mindset, we consistently strive to lead the way in our field. Our
            diverse and talented team brings together a wealth of knowledge,
            experience, and fresh perspectives, fostering an environment where
          ...
          <div>
            ...
            <div className="mt-[16px] border-1 border-[#EDEDF2] bg-[#F6F6F8] rounded-[12px] p-[16px] ">
              ...
              <div className="flex justify-end space-x-[10px]">
                <a
                  href="https://www.linkedin.com/in/samuel-onidare-53a75a10/"
